        ...
        try {
            ...
            if(paymentOption === "COD") {
                const { data } = await axios.post("/api/order/cod", {
                    userId: user._id,
                    items: cartArray.map(item => ({product: item._id, quantity: item.quantity})),  // in the "items", send only the individual item ID, hence we are mapping each to get the ID
