...
const AddProduct = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            console.log("Reaches before axios.post")
            const { data } = await axios.post("/api/product/add", formData);
            console.log("Reacher after axios.post")
            ...
            console.log("Error in AddProduct jsx file: ", error);
    ...
    return (
        <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form
                ...
                <button className="px-8 py-2.5 bg-primary text-white font-medium rounded cursor-pointer hover:bg-primary-dull">Add Product</button>
            </form>
        </div>
    );
};
