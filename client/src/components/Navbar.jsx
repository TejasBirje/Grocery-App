    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                            ...
                            <Link to="https://github.com/TejasBirje" className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer'>Github</Link>
            ...
            {open && (<div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
                ...
                {user && (<NavLink to="/my-orders" onClick={() => setOpen(false)}>
                    My Orders
                </NavLink>)}
